...
export const invoiceSchema = z.object({
  ...
  // Additional details (Task 3/4)
  eway_bill_no: z.string().optional().nullable(),
  suppliers_ref: z.string().optional().nullable(),
  other_ref: z.string().optional().nullable(),
  ...
  dispatch_through: z.string().optional().nullable(),
  ...
  consignee_state_code: z.coerce.number().optional().nullable(),
  declaration_text: z.string().optional().nullable(),
  show_receiver_signature: z.boolean().optional().default(true),
});
